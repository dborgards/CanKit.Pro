...
| [CanKit.Pro.CANopen](canopen.md) | [![NuGet](https://img.shields.io/nuget/v/CanKit.Pro.CANopen?style=flat-square&label=&color=10233f)](https://www.nuget.org/packages/CanKit.Pro.CANopen) | Node whose object dictionary carries the communication profile and drives it: SDO client/server incl. block transfer, PDO engine with every CiA 301 transmission type and SDO-configurable mapping, NMT, heartbeat, node and life guarding, SYNC, EMCY; object dictionary loadable from an EDS/DCF. | CiA 301, CiA 306 |
