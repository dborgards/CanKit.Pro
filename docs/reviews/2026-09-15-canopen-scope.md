...
| 23 | **Die Regel hinter 20, 21 und 22:** für jedes Kommunikationsobjekt, das der Knoten anbietet, stimmen OD und Laufzeit in **beiden Richtungen** und in **beiden Pfaden** überein | **Architektur** | Ein SDO-Schreibzugriff erreicht den Dienst, und jede API, die den Dienst ändert, schreibt den Wert ins OD zurück. Bisher bekannte Instanzen: `1006h`/SYNC-Produzent (20), `1016h`/`1017h`/Heartbeat (21), `1001h`/EMCY (22), PDO-Records (13/14/16). Die Liste ist hier dreimal in Folge je Dienst nachgezogen worden — sie steht als Regel, damit der nächste Dienst nicht als vierter Befund auffällt |
