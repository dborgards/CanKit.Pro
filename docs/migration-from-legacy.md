...
| `src/protocols/CanKit.Pro.{CANopen,J1939,Uds,Vendor}/` | → `src/CanKit.Pro.*/` |
...
Only the four L2 packages publish. `CanKit.Pro.{IsoTp,J1939Tp,CANopen,J1939,Uds,Vendor}` keep
